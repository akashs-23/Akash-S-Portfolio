const projects = [
  {
    title: 'ForKrishi AI: Voice-First Farming Assistant',
    subtitle: 'AI crop diagnosis and market support in Indian languages.',
    description: 'AI crop diagnosis and market support in Indian languages.',
    detail: 'Voice-first crop intelligence with multilingual support, field-ready access, and shareable advisory results.',
    thumbnail: '/images/forkrishi-ai_logo.png',
    tech: ['Gemini Vision', 'Next.js', 'PWA', 'Voice AI'],
    link: 'https://for-krishi-ai.vercel.app/',
    accent: '#65f28d'
  },
  {
